...
pero acepto retroalimentación estructurada de empleadores, mentores y colegas.

## Tipos de contribución que me serían útiles

### 1. Issues: retro o señalar inconsistencias
...
```
Título: Retroalimentación: [categoría]

**Categoría:** P1 | P2 | P3 | P4 | P5 | P6 | P7 | P8 | perfil-maestro | ToDo | metodología
...
[Qué me recomiendas que haga con esto]
...
```
Title: Retroalimentación: P3 — Nuclear energy risk analysis

Category: P3 y P5

Tu análisis de energía nuclear incluye beneficios pero no profundiza en los riesgos geopolíticos de proliferación de armas.

Evidencia: El tratado de no proliferación de armas nucleares (NPT) tiene excepciones que México no explora. Sugerencia: leer análisis de Arms Control Association.

Sugiero que: consideres agregar intersección sobre proliferación en P3 y P5.
```

### 2. Pull Requests: Para correcciones y mejoras

Prefiero PRs **pequeños y específicos**. No fusiones generales.
...
2. **Honestidad en sesgos**
   - Si tienes sesgo político, profesional o económico, mencionalo
   - Ejemplo: "Trabajo en Siemens Energy, esa es mi perspectiva"

3. **Respeto**
   - Me gusta mi autonomía
   - La retro es sugerencia, no orden
   - Respeta mis decisiones

---

## Qué puedo esperar (de mí) como mantenedor

1. Responder a todos los issues en máx 7 días
2. Claridad en rechazo un PR (explicar por qué)
3. Considerar retro genuino sin defensividad
...
- Discusiones recalcitrantes de política
...
| Es retroalimentación en general | Email o LinkedIn DM |
...
| Definiciones | SÍ | Si yo las acepto |
...
R: Tal véz. Qué tienes en mente? P1-P8 es estructura establecida, intenta sugerir tema nuevo que quepa en alguno de los 8.
...
R: Me comprometo a responder en máximo 7 días. Si no, es causa de fuerza mayor.

**P: ¿Puedo hacer PR para cambiar empresas objetivo?**
R: No, eso es decisión personal mía. Puedes sugerir análisis de empresas en una issue.
...
Para todxs la luz, para todxs todo.
```
